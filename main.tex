...
\end{equation}
This equation is the central identity of quantum teleportation. It shows that when qubits 1 and 2 are written in the Bell basis, Bob's qubit 3 is related to the original input state by one of four possible Pauli operations.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Based on the landmark 1998 study by Boschi \textit{et al.}, the experimental realization of quantum teleportation can be effectively achieved using a streamlined two-photon optical setup. Unlike the original theoretical proposals that required three distinct photons, this approach utilizes $k$-vector (path) entanglement to establish the Einstein-Podolsky-Rosen (EPR) channel, while utilizing the polarization degree of freedom of one of the entangled photons to encode the unknown quantum state. This dual-degree-of-freedom architecture simplifies the physical requirements and allows for a theoretical Bell measurement success rate of 100\%.
